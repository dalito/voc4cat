...
Use this folder to provide your own custom template, for example, with a help sheet. Note that templates may not contain any of the sheets that are dynamically created in v1.0.0.
